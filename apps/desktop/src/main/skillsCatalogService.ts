...
function getSkillsApiConfig(): SkillsApiConfig {
  ...
  throw new Error(
    'Skills catalog requires a Vercel OIDC token. Enable OIDC Federation in a Vercel project, start CodePilotX with VERCEL_OIDC_TOKEN in the environment, then restart CodePilotX. Setup guide: https://www.skills.sh/docs/api#authentication',
  )
}
