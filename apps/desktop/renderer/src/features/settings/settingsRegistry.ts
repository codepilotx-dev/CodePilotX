    ...
    items: [
      {
        ...
        rows: [
          ...
          row('听写', '查看本地语音模型状态、选择麦克风并使用听写快捷键'),
      ...
      },
      {
        ...
        rows: [
          ...
          row('专用模型', '按用途配置辅助能力使用的模型'),
          row('生成模型', '用于任务建议和会话标题生成与更新'),
          row('整理模型', '用于记忆提取和任务上下文整理'),
          row('代码模型', '用于计划实施和 AI 代码审查'),
          row('安全模型（实验）', '用于 Shell 和工具权限自动审核'),
