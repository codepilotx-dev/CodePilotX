        ...
        <Dialog.Content
            ...
            >
              ...
              >
                ...
                <input
                  aria-label={title}
                  className="confirmation-dialog-input tw:w-full tw:rounded-xs tw:border tw:border-app-border tw:bg-app-canvas tw:px-3 tw:py-2 tw:text-base tw:text-app-text tw:outline-none tw:transition-[border-color,box-shadow] tw:duration-[var(--cpx-sys-motion-enter)] tw:focus:border-app-accent tw:focus:ring-2 tw:focus:ring-app-accent"
