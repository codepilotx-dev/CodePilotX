...
function GlobalErrorPresence({
  ...
  return (
    <motion.div
      ...
      className={`global-error-toast ${isError ? '' : 'status'} tw:flex tw:max-w-[min(55rem,calc(100vw-2rem))] tw:items-start tw:gap-2 tw:rounded-xl tw:border tw:border-app-border tw:bg-app-raised tw:px-3 tw:py-2 tw:text-app-text`}
