...
import { generateFileSuggestions } from '@claudecode/tui/hooks/fileSuggestions.js'
import type { ServerResource } from '@claudecode/tui/services/mcp/types.js'
import { getAgentColor } from '@claudecode/tui/tools/AgentTool/agentColorManager.js'
import type { AgentDefinition } from '@claudecode/tui/tools/AgentTool/loadAgentsDir.js'
import { truncateToWidth } from '@claudecode/tui/utils/format.js'
