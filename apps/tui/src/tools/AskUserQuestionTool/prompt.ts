...
- If you recommend a specific option, make that the first option in the list. Do not add "(Recommended)" to the label; the UI marks the first option as recommended automatically.
