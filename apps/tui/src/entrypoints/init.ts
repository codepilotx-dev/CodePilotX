...
import { getIsNonInteractiveSession } from '@codepilotx/tui/bootstrap/state.js'
 ...
 * No-op since all telemetry has been removed.
 * Preserved as a public export so callers don't need updating.
 */
export function initializeTelemetryAfterTrust(): void {
  // No-op — all telemetry has been removed
}
