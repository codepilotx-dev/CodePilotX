...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'CODEPILOTX_FAST_MODEL_DESCRIPTION',
  'CODEPILOTX_FAST_MODEL_NAME',
  'CODEPILOTX_FAST_MODEL_SUPPORTED_CAPABILITIES',
  'CODEPILOTX_DEFAULT_MODEL',
  'CODEPILOTX_DEFAULT_MODEL_DESCRIPTION',
  'CODEPILOTX_DEFAULT_MODEL_NAME',
  'CODEPILOTX_DEFAULT_MODEL_SUPPORTED_CAPABILITIES',
 ...
 * These are CodePilotX specific settings that don't pose security risks.
 *
