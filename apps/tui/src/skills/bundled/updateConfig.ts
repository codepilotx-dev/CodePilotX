...
Hooks run commands at specific points in CodePilotX's lifecycle.
...
Modify CodePilotX configuration by updating settings.json files.
...
6. **Use --debug** - Run \`codepilotx --debug\` to see hook execution logs
`
