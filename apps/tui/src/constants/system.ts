...
const DEFAULT_PREFIX = `You are CodePilotX, an AI coding agent.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are CodePilotX, an AI coding agent running within the Claude Agent SDK.`
...
function isAttributionHeaderEnabled(): boolean {
  if (
    isEnvDefinedFalsy(process.env.CODEPILOTX_ATTRIBUTION_HEADER) ||
