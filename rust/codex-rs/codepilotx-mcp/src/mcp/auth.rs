...
use codepilotx_rmcp_client::OAuthProviderError;
use codepilotx_rmcp_client::determine_streamable_http_auth_status;
use codepilotx_rmcp_client::discover_streamable_http_oauth;
use futures::future::join_all;
use tracing::warn;

use crate::server::EffectiveMcpServer;

use super::codepilotx_APPS_MCP_SERVER_NAME;
    ...
    I: IntoIterator<Item = (&'a String, &'a EffectiveMcpServer)>,
{
    let futures = servers.into_iter().map(|(name, server)| {
        ...
        let has_runtime_auth = name == codepilotx_APPS_MCP_SERVER_NAME
