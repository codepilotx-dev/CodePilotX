...
pub const MCP_TOOL_codepilotx_APPS_META_KEY: &str = "_codepilotx_apps";
...
pub fn auth_elicitation_id(call_id: &str) -> String {
    format!("codepilotx_apps_auth_{call_id}")
}
...
mod tests {
    ...
    fn builds_auth_elicitation_plan() {
        ...
        assert_eq!(plan.elicitation.elicitation_id, "codepilotx_apps_auth_call_123");
    }
}
