...
use codepilotx_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use codepilotx_protocol::protocol::SkillInterface as CoreSkillInterface;
use codepilotx_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use codepilotx_protocol::protocol::SkillScope as CoreSkillScope;
use codepilotx_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
