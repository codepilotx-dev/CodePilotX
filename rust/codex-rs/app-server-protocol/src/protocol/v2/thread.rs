...
pub use codepilotx_protocol::capabilities::CapabilityRootLocation;
pub use codepilotx_protocol::capabilities::SelectedCapabilityRoot;
...
use codepilotx_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use codepilotx_protocol::protocol::TokenUsage as CoreTokenUsage;
use codepilotx_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "codepilotx_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
...
impl From<codepilotx_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: codepilotx_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> codepilotx_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => codepilotx_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => codepilotx_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
