...
use codepilotx_protocol::protocol::HookEventName as CoreHookEventName;
use codepilotx_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use codepilotx_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use codepilotx_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use codepilotx_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use codepilotx_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use codepilotx_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use codepilotx_protocol::protocol::HookScope as CoreHookScope;
use codepilotx_protocol::protocol::HookSource as CoreHookSource;
use codepilotx_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
