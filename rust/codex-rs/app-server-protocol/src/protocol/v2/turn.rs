...
use codepilotx_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use codepilotx_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use codepilotx_protocol::user_input::ByteRange as CoreByteRange;
use codepilotx_protocol::user_input::TextElement as CoreTextElement;
