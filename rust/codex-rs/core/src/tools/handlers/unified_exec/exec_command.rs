...
use codepilotx_otel::TOOL_CALL_UNIFIED_EXEC_METRIC;
...
use codepilotx_shell_command::shell_detect::detect_shell_type;
...
impl ExecCommandHandler {
    async fn handle_call(
        ...
        let command_for_display = codepilotx_shell_command::parse_command::shlex_join(&command);
