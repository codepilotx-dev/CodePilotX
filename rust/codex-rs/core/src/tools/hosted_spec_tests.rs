...
use codepilotx_protocol::config_types::WebSearchFilters;
use codepilotx_protocol::config_types::WebSearchUserLocation;
use codepilotx_protocol::config_types::WebSearchUserLocationType;
use codepilotx_tools::ResponsesApiWebSearchFilters;
use codepilotx_tools::ResponsesApiWebSearchUserLocation;
