...
pub(crate) struct GuardianAssessment {
    pub(crate) risk_level: codepilotx_protocol::protocol::GuardianRiskLevel,
    pub(crate) user_authorization: codepilotx_protocol::protocol::GuardianUserAuthorization,
