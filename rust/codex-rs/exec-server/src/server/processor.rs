    ...
    while let Some(event) = incoming_rx.recv().await {
        ...
        match event {
            ...
            JsonRpcConnectionEvent::Message(message) => match message {
                codepilotx_app_server_protocol::JSONRPCMessage::Request(request) => {
                ...
                codepilotx_app_server_protocol::JSONRPCMessage::Notification(notification) => {
                ...
                codepilotx_app_server_protocol::JSONRPCMessage::Response(response) => {
                    warn!(
                ...
                codepilotx_app_server_protocol::JSONRPCMessage::Error(error) => {
                    warn!(
