...
pub struct ConfigToml {
    ...
    /// Defaults to `$codepilotx_SQLITE_HOME` when set. Otherwise uses `$codepilotx_HOME`.
    ...
    /// Defaults to `$codepilotx_HOME/log`.
...
pub struct DebugConfigLockToml {
    ...
    pub allow_codepilotx_version_mismatch: Option<bool>,
...
pub use codepilotx_protocol::protocol::RealtimeConversationVersion as RealtimeWsVersion;
pub use codepilotx_protocol::protocol::RealtimeVoice;
