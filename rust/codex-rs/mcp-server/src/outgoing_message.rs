...
// Additional mcp-specific data to be added to a [`codepilotx_protocol::protocol::Event`] as notification.params._meta
    ...
    async fn test_send_event_as_notification() -> Result<()> {
        ...
        let event = Event {
            ...
            msg: EventMsg::SessionConfigured(SessionConfiguredEvent {
                session_id: codepilotx_protocol::SessionId::new(),
                thread_id,
                forked_from_id: None,
