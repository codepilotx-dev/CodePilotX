...
#[test]
fn test_deserialize_anthropic_messages_wire_api_normalized_alias() {
    let provider_toml = r#"
name = "MiniMax Anthropic"
base_url = "https://api.minimaxi.com/anthropic/v1"
env_key = "MINIMAX_API_KEY"
...
#[test]
fn test_personal_access_token_uses_chatgpt_codepilotx_base_url() {
    ...
    assert_eq!(api_provider.base_url, CHATGPT_codepilotx_BASE_URL);
}
