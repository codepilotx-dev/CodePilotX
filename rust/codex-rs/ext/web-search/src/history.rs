use codepilotx_api::SearchInput;
...
use codepilotx_tools::retain_tail_from_last_n_user_messages;
use codepilotx_tools::truncate_assistant_output_text_to_token_budget;
