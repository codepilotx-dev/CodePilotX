...
const OFFLINE_BLOCK_RULE_NAME: &str = "codepilotx_sandbox_offline_block_outbound";
const OFFLINE_BLOCK_LOOPBACK_TCP_RULE_NAME: &str = "codepilotx_sandbox_offline_block_loopback_tcp";
const OFFLINE_BLOCK_LOOPBACK_UDP_RULE_NAME: &str = "codepilotx_sandbox_offline_block_loopback_udp";
...
const OFFLINE_PROXY_ALLOW_RULE_NAME: &str = "codepilotx_sandbox_offline_allow_loopback_proxy";
