...
pub fn find_runner_exe(codepilotx_home: &Path, log_dir: Option<&Path>) -> PathBuf {
    resolve_helper_for_launch(HelperExecutable::CommandRunner, codepilotx_home, log_dir)
}
