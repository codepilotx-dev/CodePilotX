...
pub(super) const FILTER_SPECS: &[FilterSpec] = &[
    FilterSpec {
        ...
        name: "codepilotx_wfp_icmp_connect_v4",
    ...
    FilterSpec {
        ...
        name: "codepilotx_wfp_icmp_connect_v6",
    ...
    FilterSpec {
        ...
        name: "codepilotx_wfp_icmp_assign_v4",
    ...
    FilterSpec {
        ...
        name: "codepilotx_wfp_icmp_assign_v6",
    ...
    FilterSpec {
        ...
        name: "codepilotx_wfp_dns_853_v4",
    ...
    FilterSpec {
        ...
        name: "codepilotx_wfp_dns_853_v6",
    ...
    FilterSpec {
        ...
        name: "codepilotx_wfp_smb_445_v4",
    ...
    FilterSpec {
        ...
        name: "codepilotx_wfp_smb_445_v6",
    ...
    FilterSpec {
        ...
        name: "codepilotx_wfp_smb_139_v4",
    ...
    FilterSpec {
        ...
        name: "codepilotx_wfp_smb_139_v6",
