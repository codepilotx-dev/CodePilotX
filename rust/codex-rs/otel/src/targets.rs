pub(crate) const OTEL_TARGET_PREFIX: &str = "codepilotx_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "codepilotx_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "codepilotx_otel.trace_safe";
