...
use super::CodePilotXHomeUserInstructionsProvider;
use super::DEFAULT_AGENTS_MD_FILENAME;
use super::LOCAL_AGENTS_MD_FILENAME;

fn provider(home: &TempDir) -> CodePilotXHomeUserInstructionsProvider {
    CodePilotXHomeUserInstructionsProvider::new(
