...
fn daily_graph_snapshot_uses_distinct_empty_and_active_cells() {
    ...
    assert_snapshot!(rendered, @r"
         Apr     May
    Su 鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?    Mo 鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?    Tu 鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?    We 鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?    Th 鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?    Fr 鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?    Sa 鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?
      Less 鈻?鈻?鈻?鈻?鈻?More
      daily 路 weekly 路 cumulative
    ");
}
...
fn daily_graph_snapshot_stays_left_aligned_in_wide_terminal() {
    ...
    assert_snapshot!(rendered, @"
     ...
     Su 鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?鈻?       daily 路 weekly 路 cumulative
    ");
}
...
fn weekly_graph_snapshot_renders_bar_chart_and_caption() {
    ...
    assert_snapshot!(rendered, @"
          Apr     May
    max                 鈻?                        鈻?                      鈻?鈻?                      鈻?鈻?                    鈻?鈻?鈻?                    鈻?鈻?鈻?      0             鈻?鈻?鈻?
       Each column = 1 week 路 tallest 9
       daily 路 weekly 路 cumulative
    ");
}
...
fn cumulative_graph_snapshot_renders_running_total_bar_chart_and_caption() {
    ...
    assert_snapshot!(rendered, @"
          Apr     May
    max                 鈻?                        鈻?                        鈻?                      鈻?鈻?                      鈻?鈻?                    鈻?鈻?鈻?      0             鈻?鈻?鈻?
       Running total 路 top 18
       daily 路 weekly 路 cumulative
    ");
}
...
fn summary_snapshot_left_aligns_and_splits_when_needed() {
    ...
    assert_snapshot!(
        ...
        @"
    wide:
     Lifetime 21.4B 路 Peak 835M 路 Streak 54d 路 Longest task 3h 52m

    narrow:
     Lifetime 21.4B 路 Peak 835M 路 Streak 54d 路 Longest task 3h 52m

    tight:
     Lifetime 21.4B 路 Peak 835M 路 Streak 54d
     Longest task 3h 52m
    "
    );
}
