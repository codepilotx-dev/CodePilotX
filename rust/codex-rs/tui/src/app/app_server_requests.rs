...
mod tests {
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = codepilotx_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: codepilotx_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: codepilotx_protocol::request_permissions::PermissionGrantScope::Session,
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        entries: Some(vec![
                            codepilotx_app_server_protocol::FileSystemSandboxEntry {
                                ...
                                access: codepilotx_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            codepilotx_app_server_protocol::FileSystemSandboxEntry {
                                path: codepilotx_app_server_protocol::FileSystemPath::Path {
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: codepilotx_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: codepilotx_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: codepilotx_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
