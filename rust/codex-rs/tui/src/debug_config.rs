...
use codepilotx_config::NetworkUnixSocketPermissionToml;
...
use codepilotx_config::WebSearchModeRequirement;
use codepilotx_config::format_config_layer_source;
...
mod tests {
    ...
    use codepilotx_config::FilesystemConstraints;
    ...
    use codepilotx_config::NetworkUnixSocketPermissionToml;
    use codepilotx_config::NetworkUnixSocketPermissionsToml;
    use codepilotx_config::RequirementSource;
    use codepilotx_config::ResidencyRequirement;
    use codepilotx_config::SandboxModeRequirement;
    ...
    fn debug_config_output_lists_all_layers_including_disabled() {
        ...
        let layers = vec![
            ...
            ConfigLayerEntry::new_disabled(
                ConfigLayerSource::Project {
                    dot_codepilotx_folder: project_folder,
                },
                empty_toml_table(),
