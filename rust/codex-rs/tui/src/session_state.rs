...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: codepilotx_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<codepilotx_protocol::openai_models::ReasoningEffort>,
