...
use codepilotx_app_server_protocol::CommandExecResizeResponse;
...
use codepilotx_app_server_protocol::CommandExecTerminateResponse;
use codepilotx_app_server_protocol::CommandExecWriteParams;
use codepilotx_app_server_protocol::CommandExecWriteResponse;
use codepilotx_app_server_protocol::JSONRPCErrorError;
use codepilotx_app_server_protocol::ServerNotification;
use codepilotx_core::config::StartedNetworkProxy;
use codepilotx_core::exec::ExecExpiration;
use codepilotx_core::exec::ExecExpirationOutcome;
use codepilotx_core::exec::IO_DRAIN_TIMEOUT_MS;
use codepilotx_core::sandboxing::ExecRequest;
use codepilotx_protocol::exec_output::bytes_to_string_smart;
use codepilotx_sandboxing::SandboxType;
use codepilotx_utils_pty::DEFAULT_OUTPUT_BYTES_CAP;
use codepilotx_utils_pty::ProcessHandle;
...
mod tests {
    ...
    fn windows_sandbox_exec_request() -> ExecRequest {
        ...
        ExecRequest::new(
            ...
            codepilotx_core::exec::ExecCapturePolicy::ShellTool,
        ...
        let err = manager
            .start(StartCommandExecParams {
                ...
                request_id: ConnectionRequestId {
                    ...
                    request_id: codepilotx_app_server_protocol::RequestId::Integer(42),
                },
    ...
    async fn windows_sandbox_non_streaming_exec_uses_execution_path() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: codepilotx_app_server_protocol::RequestId::Integer(99),
        };
    ...
    async fn cancellation_expiration_keeps_process_alive_until_terminated() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: codepilotx_app_server_protocol::RequestId::Integer(100),
        };
        let cwd = AbsolutePathBuf::current_dir().expect("current dir");
    ...
    async fn timeout_or_cancellation_reports_cancellation_without_timeout_exit_code() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: codepilotx_app_server_protocol::RequestId::Integer(101),
        };
    ...
    async fn windows_sandbox_process_ids_reject_write_requests() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: codepilotx_app_server_protocol::RequestId::Integer(1),
        };
    ...
    async fn windows_sandbox_process_ids_reject_terminate_requests() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: codepilotx_app_server_protocol::RequestId::Integer(2),
        };
        let process_id = ConnectionProcessId {
            connection_id: request_id.connection_id,
    ...
    async fn dropped_control_request_is_reported_as_not_running() {
        ...
        let request_id = ConnectionRequestId {
            ...
            request_id: codepilotx_app_server_protocol::RequestId::Integer(3),
        };
