    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: codepilotx_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        codepilotx_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                codepilotx_app_server_protocol::AdditionalFileSystemPermissions {
