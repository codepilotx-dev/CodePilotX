...
use codepilotx_app_server_protocol::PluginShareTargetRole;
use codepilotx_config::types::McpServerConfig;
use codepilotx_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use codepilotx_core_plugins::PluginListBackgroundTaskOptions;
use codepilotx_core_plugins::is_openai_curated_marketplace_name;
use codepilotx_core_plugins::remote::REMOTE_CREATED_BY_ME_MARKETPLACE_NAME;
...
use codepilotx_core_plugins::remote::RemoteAppTemplateUnavailableReason;
use codepilotx_core_plugins::remote::is_valid_remote_plugin_id;
use codepilotx_core_plugins::remote::validate_remote_plugin_id;
use codepilotx_core_plugins::remote_bundle::RemotePluginBundleInstallError;
use codepilotx_mcp::McpOAuthLoginSupport;
use codepilotx_mcp::oauth_login_support;
use codepilotx_mcp::should_retry_without_scopes;
use codepilotx_plugin::PluginId;
use codepilotx_plugin::PluginTelemetryMetadata;
use codepilotx_rmcp_client::perform_oauth_login_silent;
...
fn load_shared_plugin_ids_by_local_path(
    ...
    codepilotx_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
...
) -> codepilotx_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            codepilotx_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            codepilotx_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            codepilotx_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> codepilotx_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Unlisted => {
            codepilotx_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            codepilotx_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> codepilotx_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            codepilotx_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            codepilotx_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: codepilotx_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        codepilotx_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        codepilotx_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        codepilotx_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<codepilotx_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| codepilotx_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        codepilotx_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        codepilotx_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        codepilotx_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: codepilotx_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    ...
    async fn plugin_list_response(
        ...
        let use_remote_global_catalog =
            include_global_remote && auth_mode.is_some_and(AuthMode::uses_codepilotx_backend);
        let remote_plugin_service_config = RemotePluginServiceConfig {
            chatgpt_base_url: config.chatgpt_base_url.clone(),
        };
        let refresh_global_remote_catalog_cache = use_remote_global_catalog
            && codepilotx_core_plugins::remote::has_cached_global_remote_plugin_catalog(
                config.codepilotx_home.as_path(),
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<codepilotx_app_server_protocol::MarketplaceLoadErrorInfo>,
                    ),
                    MarketplaceError,
                >((
                    outcome
        ...
        if include_vertical && !config.features.enabled(Feature::RemotePlugin) {
            match codepilotx_core_plugins::remote::fetch_openai_curated_remote_collection_marketplace(
                &remote_plugin_service_config,
                auth.as_ref(),
            )
            .await
        ...
        if !remote_sources.is_empty() {
            match codepilotx_core_plugins::remote::fetch_remote_marketplaces(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_sources,
                /*global_catalog_cache_path*/ Some(config.codepilotx_home.as_path()),
            )
            .await
            {
    ...
    async fn load_local_installed_and_suggested_plugins(
        &self,
        plugins_manager: Arc<codepilotx_core_plugins::PluginsManager>,
        config: &Config,
        plugins_input: &codepilotx_core_plugins::PluginsConfigInput,
    ...
    async fn plugin_read_response(
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        ...
                        match codepilotx_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| codepilotx_app_server_protocol::PluginHookSummary {
                            key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail = codepilotx_core_plugins::remote::fetch_remote_plugin_detail(
                    &remote_plugin_service_config,
                    auth.as_ref(),
                    &remote_marketplace_name,
                    &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(codepilotx_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
    ...
    async fn plugin_share_save_response(
        ...
        let access_policy = codepilotx_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = codepilotx_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codepilotx_home.as_path(),
            &plugin_path,
    ...
    async fn plugin_share_update_targets_response(
        ...
        let result = codepilotx_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let data = codepilotx_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codepilotx_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let result = codepilotx_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codepilotx_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        codepilotx_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codepilotx_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_install_response(
        ...
        let plugin_apps =
            codepilotx_plugin::app_connector_ids_from_declarations(&plugin_app_declarations);
    ...
    async fn remote_plugin_install_response(
        ...
        let remote_detail =
            codepilotx_core_plugins::remote::fetch_remote_plugin_detail_with_download_urls(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_marketplace_name,
                &remote_plugin_id,
        ...
        let _remote_plugin_cache_mutation =
            codepilotx_core_plugins::remote::mark_remote_plugin_cache_mutation_in_flight(
                config.codepilotx_home.as_path(),
        ...
        let install_result = codepilotx_core_plugins::remote::install_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            &actual_remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        plugin_id: &str,
        plugin_apps: &[codepilotx_plugin::AppConnectorId],
    ) -> Vec<AppSummary> {
        ...
        let (accessible_connectors, codepilotx_apps_ready) = match accessible_connectors_result {
            Ok(status) => (status.connectors, status.codepilotx_apps_ready),
            Err(err) => {
                warn!(
                    plugin = plugin_id,
        ...
        if !codepilotx_apps_ready {
            warn!(
                plugin = plugin_id,
                "codepilotx_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
            );
        }
    ...
    async fn plugin_uninstall_response(
        ...
        if codepilotx_plugin::PluginId::parse(&plugin_id).is_err()
    ...
    async fn remote_plugin_uninstall_response(
        ...
        let uninstall_result = codepilotx_core_plugins::remote::uninstall_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.codepilotx_home.to_path_buf(),
            &plugin_id,
...
fn plugin_app_category_by_id_from_value(value: &serde_json::Value) -> HashMap<String, String> {
    codepilotx_core_plugins::loader::plugin_app_declarations_from_value(value)
        .into_iter()
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: codepilotx_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: codepilotx_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
