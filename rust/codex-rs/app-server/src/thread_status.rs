...
use codepilotx_app_server_protocol::ThreadActiveFlag;
    ...
    async fn tracks_non_interactive_thread_status() {
        ...
        manager
            .upsert_thread(test_thread(
                ...
                codepilotx_app_server_protocol::SessionSource::AppServer,
            ))
            .await;
    ...
    async fn status_updates_track_single_thread() {
        ...
        manager
            .upsert_thread(test_thread(
                ...
                codepilotx_app_server_protocol::SessionSource::Cli,
            ))
            .await;
