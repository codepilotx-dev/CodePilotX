...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for Oh-My-AgentCode.\n' +
  '\n' +
  'Oh-My-AgentCode has an "auto mode" that uses an AI classifier to decide whether ' +
