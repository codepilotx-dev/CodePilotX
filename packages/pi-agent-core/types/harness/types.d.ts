...
export interface HarnessTurnComposition<TContext extends object | undefined, TSkill extends Skill = Skill, TPromptTemplate extends PromptTemplate = PromptTemplate, TTool extends AgentHarnessTool<TContext> = AgentHarnessTool<TContext>> {
...
export interface SavePointEvent {
    ...
    /** Active tool snapshot durably represented by the session leaf at this save point. */
    activeToolNames: string[];
}
 ...
 */
export type AgentHarnessSystemPrompt<TContext extends object | undefined = undefined, TSkill extends Skill = Skill, TPromptTemplate extends PromptTemplate = PromptTemplate, TTool extends AgentHarnessTool<TContext> = AgentHarnessTool<TContext>> = string;
...
export type AgentHarnessOptions<TContext extends object | undefined = undefined, TSkill extends Skill = Skill, TPromptTemplate extends PromptTemplate = PromptTemplate, TTool extends AgentHarnessTool<TContext> = AgentHarnessTool<TContext>> = AgentHarnessOptionsBase<TContext, TSkill, TPromptTemplate, TTool>;
