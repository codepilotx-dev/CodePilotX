...
test('providerToCodexToml maps desktop provider selection to Codex config edits', () => {
  expect(
    providerToCodexToml(
      {
        providerID: 'minimax',
    ...
    { keyPath: 'model', value: 'minimax-m1', mergeStrategy: 'replace' },
    { keyPath: 'model_provider', value: 'minimax', mergeStrategy: 'replace' },
    {
      keyPath: 'model_providers.minimax.base_url',
      value: 'https://api.minimax.io/v1',
      mergeStrategy: 'replace',
    },
    {
      keyPath: 'model_providers.minimax.name',
      value: 'MiniMax',
      mergeStrategy: 'replace',
    },
    {
      keyPath: 'model_providers.minimax.env_key',
