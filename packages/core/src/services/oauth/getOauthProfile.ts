...
import { getOauthConfig, OAUTH_BETA_HEADER } from './constants.js'
...
> {
  ...
  try {
    ...
    console.error('getOauthProfileFromApiKey failed:', error)
  }
}
...
export async function getOauthProfileFromOauthToken(
  ...
  try {
    ...
    console.error('getOauthProfileFromOauthToken failed:', error)
  }
}
