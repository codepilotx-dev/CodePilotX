import type { AgentPermissionRequest, AgentSessionEvent, AgentSessionMessage, AgentSessionStatus } from './runtime.js'
...
export function deriveWorkflowSessionView(
  ...
  let turnStatus: AgentSessionStatus = 'idle'
...
function eventId(event: ThreadEvent): string {
